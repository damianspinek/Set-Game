...
public class GameFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cards.add((CheckBox)getView().findViewById(R.id.button4));
        cards.add((CheckBox)getView().findViewById(R.id.button5));
        cards.add((CheckBox)getView().findViewById(R.id.button6));
        cards.add((CheckBox)getView().findViewById(R.id.button7));
        cards.add((CheckBox)getView().findViewById(R.id.button8));
        cards.add((CheckBox)getView().findViewById(R.id.button9));
